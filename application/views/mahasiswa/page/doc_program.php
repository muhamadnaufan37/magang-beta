        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <?php $no=1; foreach($user_file2 as $file2){ ?>
                    <?php if ($file2['status_doc'] == '0') { ?>   
                                ...
                                <div class="alert alert-warning alert-dismissible">
                                    <div class="card-body pad table-responsive">
                                        <font color="black">
                                            ...
                                            <li>File yang dikirim harus berbentuk <strong>.Zip atau .Rar</strong></li>
                                            <li>Ukuran File <strong>Tidak Boleh Lebih Dari 100Mb</strong></li>
                                            <li>jika file melebihi kapasitas yang ditentukan silahkan upload di penyimanan lain (contoh: Google Drive) dan copy link program yang telah di upload di penyimpanan lain ke form yang telah disediakan.</li>
                                        </font>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="post" action="<?php echo base_url('mahasiswa/doc_program'); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                        <label for="link_program">Notes/Link Berkas (beri "-" jika tidak ada)</label>
                                        <input type="text" class="form-control" value="" id="link_program" name="link_program" placeholder="contoh link yang dikirim: https://github.com/user/programuser" required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="images[]" class="form-label">Upload Dokumen Program</label><br>
                                        ...
                                        <?php $no=1; foreach($user_file2 as $file2){ ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="project-actions text-right">
                                                      <a class="badge badge-dark badge-md" type="button" value="Cek Link" target="_blank" href="<?= $file2['link_program']; ?>" style="width: 100%">
                                                          Cek Link
                                                      </a>
                                                    </td>
                                                    <!-- <td><?= $file2['link_program']; ?></td> -->
                                                    <td class="text-muted">
                                                        <?php if ($file2['doc_program'] == '') { ?>
                                                        <div class="text-reset"><em>File Tidak Diitemukan</em></div>
                                                      <?php }else {
                                                        echo $file2['doc_program'];
                                                      } ?>
                                                    </td>
                                                    <td>
                                                        <?php if ($file2['status_doc'] == '0') { ?>
                                                    ...
                                                    <td>
                                                        <?php if ($file2['status_doc'] == '0') { ?>
                                                            <a onclick="return confirm('apakah anda yakin ingin menghapus data ini?')" class="btn btn-block btn-danger btn-sm" href="<?=base_url('mahasiswa/doc_program_delete/'.$file2['id_surat'])?>">
                                                                <span class="fa fa-trash"></span>
                                                            </a>
                                                         <?php } ?>
                                                        <?php if ($file2['status_doc'] == '1') { ?>
                                                            <a onclick="return confirm('apakah anda yakin ingin menghapus data ini?')" class="btn btn-block btn-danger btn-sm disabled" href="<?=base_url('mahasiswa/doc_program_delete/'.$file2['id_surat'])?>">
                                                                <span class="fa fa-trash"></span>
                                                            </a>
                                                         <?php } ?>
                                                        <?php if ($file2['status_doc'] == '2') { ?>
