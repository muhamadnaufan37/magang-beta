...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/template')?>/dist3/esertifikat/css/style.css">
    ...
    <div class="pm-certificate-border col-xs-12">
      <div class="row pm-certificate-header">
        <div class="pm-certificate-title cursive col-xs-12 text-center">
          <h2>Dinas Komunikasi Dan Informatika Kabupaten Purwakarta</h2>
        </div>
      </div>
            ...
            <div class="col-xs-12">
              <div class="row">
                ...
                <div class="pm-certificate-name underline margin-0 col-xs-8 text-center">
                  <span class="pm-name-text bold"><?= $user['nama']; ?></span>
                </div>
                <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
              </div>
            </div>          
