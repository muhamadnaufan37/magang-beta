                 ...
                 <section class="col-lg-12 connectedSortable">
                        <div class="card card-danger">
                              <div class="card-header">
                                <h6 class="card-title"><strong>FORM BIO ACCOUNT | Form Isian dengan tanda</strong></h6>
                              </div>
                          <div class="card-body">
                            <div class="block-content">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form method="post" action="<?php echo base_url('superadmin/edit_account'); ?>" enctype="multipart/form-data">
                                            <div class="form-row">
