                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example2" class="display table dataTable table-striped table-bordered text-center" >
                                        ...
                                        <tbody>
                                            <?php $no=1; foreach($admin_file1 as $file){ ?>
                                            <tr>
                                                <td><?=$no++?></td>
                                                <td><?= $file['nama']; ?></td>
                                                ...
                                                <td>
                                                    <a class="btn btn-block btn-success btn-sm" href="<?php echo base_url('superadmin/edit_bidang/?id_bidang='.$file['id_bidang'])?>">
                                                    <span class="fa fa-wrench">
                                                </td>
                                                <td>
                                                    <a onclick="return confirm('apakah anda yakin ingin menghapus data ini?')" class="btn btn-block btn-danger btn-sm" href="<?=base_url('superadmin/delete_bidang/'.$file['id_bidang'])?>">
